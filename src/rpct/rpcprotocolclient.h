...
namespace jsonrpc {
    ...
    /**
     * @brief The RpcProtocolClient class handles the json-rpc 2.0 protocol for
     * the client side.
     */
    class RpcProtocolClient {
      public:
        RpcProtocolClient(bool omitEndingLineFeed = false);
         ...
         * RpcProtocolClient::HandleResponse(const string& response)

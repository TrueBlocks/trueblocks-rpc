...
```sh
g++ stubserver.cpp -ljsoncpp -lmicrohttpd -ljsonrpccpp-libs -ljsonrpccpp-server -o sampleserver
```
...
```sh
g++ stubclient.cpp -ljsoncpp -lcurl -ljsonrpccpp-libs -ljsonrpccpp-client -o sampleclient
```
